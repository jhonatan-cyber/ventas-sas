...
export default async function ResetPasswordPage({
  ...
  const organizationName =
    ...
    organization.name ||
    `${organization.customerOrganizations[0]?.customer?.nombre ?? ""} ${organization.customerOrganizations[0]?.customer?.apellido ?? ""}`.trim();
    ...
    >
      <I18nProvider>
        <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-slate-50 to-gray-100 dark:from-[#0a0a0a] dark:via-[#111111] dark:to-[#1a1a1a] relative overflow-hidden">
          ...
          {/* Sección derecha - Formulario de reset password */}
