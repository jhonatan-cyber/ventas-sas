...
export function SupportTicketsTable({
  ...
  const getPriorityBadge = (priority: TicketPriority | string) => {
    ...
    return variants[priority as TicketPriority] || variants.medium
  }
  ...
  const getStatusBadge = (status: TicketStatus | string) => {
    ...
    return variants[status as TicketStatus] || variants.open
  }
                  ...
                  {tickets.map((ticket) => {
                    ...
                    return (
                      <TableRow key={ticket.id}>
                        ...
                        <TableCell>{ticket.createdBy?.fullName || ticket.createdBy?.email || "-"}</TableCell>
