...
export function UsersTable({
  ...
  const canViewDetails = useHasPermission("usuarios_ver_detalles")
  const canEdit = useHasPermission("usuarios_editar")
  const canDelete = useHasPermission("usuarios_eliminar")
  const canActivate = useHasPermission("usuarios_activar")
  const canDeactivate = useHasPermission("usuarios_desactivar")
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-50 dark:bg-[#2a2a2a] border-b border-gray-200 dark:border-[#2a2a2a]">
              ...
              <TableHead className="text-gray-700 dark:text-gray-300 font-semibold">
                <div className="flex items-center gap-2">CI</div>
              </TableHead>
              <TableHead className="text-gray-700 dark:text-gray-300 font-semibold">
                <div className="flex items-center gap-2">Rol</div>
              </TableHead>
              <TableHead className="text-gray-700 dark:text-gray-300 font-semibold">
                <div className="flex items-center gap-2">Contacto</div>
              </TableHead>
              <TableHead className="text-gray-700 dark:text-gray-300 font-semibold">
                    ...
                    <TableCell>
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            {canEdit ? "Editar usuario" : "No tiene permiso para editar usuarios"}
                          </TooltipContent>
                        </Tooltip>
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            {user.isActive
                              ? (canDeactivate ? "Desactivar usuario" : "No tiene permiso para desactivar usuarios")
                              : (canActivate ? "Activar usuario" : "No tiene permiso para activar usuarios")}
                          </TooltipContent>
                        </Tooltip>
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <span>
                              <Button
                                ...
                                onClick={() =>
                                  onDelete?.(user.id, user.fullName || user.email)
                                }
                                disabled={!canDelete}
                              >
                          ...
                          <TooltipContent>
                            {canDelete ? "Eliminar usuario" : "No tiene permiso para eliminar usuarios"}
                          </TooltipContent>
                        </Tooltip>
                      </div>
                    </TableCell>
