...
export function BillingFilters({ onPageSizeChange, onStatusChange, onSearchChange }: BillingFiltersProps) {
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex-1">
          <div className="relative">
            ...
            <Input
              type="text"
              placeholder="Buscar facturas por número, nombre, email..."
        ...
        <Select value={status} onValueChange={handleStatusChange}>
          ...
          <SelectContent className="bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#2a2a2a] text-gray-900 dark:text-white">
            ...
            <SelectItem value="pending" className="hover:bg-gray-100 dark:hover:bg-[#2a2a2a]">Pendientes</SelectItem>
            <SelectItem value="paid" className="hover:bg-gray-100 dark:hover:bg-[#2a2a2a]">Pagadas</SelectItem>
            <SelectItem value="overdue" className="hover:bg-gray-100 dark:hover:bg-[#2a2a2a]">Vencidas</SelectItem>
            <SelectItem value="cancelled" className="hover:bg-gray-100 dark:hover:bg-[#2a2a2a]">Canceladas</SelectItem>
          </SelectContent>
        </Select>
