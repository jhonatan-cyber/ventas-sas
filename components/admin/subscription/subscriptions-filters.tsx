...
export function SubscriptionsFilters({ onPageSizeChange, onStatusChange, onSearchChange }: SubscriptionsFiltersProps) {
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <Select value={status} onValueChange={handleStatusChange}>
          ...
          <SelectContent className="bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#2a2a2a] text-gray-900 dark:text-white">
            ...
            <SelectItem value="active" className="hover:bg-gray-100 dark:hover:bg-[#2a2a2a]">Activas</SelectItem>
            <SelectItem value="cancelled" className="hover:bg-gray-100 dark:hover:bg-[#2a2a2a]">Canceladas</SelectItem>
            <SelectItem value="trial" className="hover:bg-gray-100 dark:hover:bg-[#2a2a2a]">Prueba</SelectItem>
            <SelectItem value="expired" className="hover:bg-gray-100 dark:hover:bg-[#2a2a2a]">Expiradas</SelectItem>
          </SelectContent>
        </Select>
