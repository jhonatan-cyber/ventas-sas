...
export function CustomerOrganizationsFilters({ onPageSizeChange, onStatusChange, onSearchChange }: CustomerOrganizationsFiltersProps) {
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex-1">
          <div className="relative">
            ...
            <Input
              type="text"
              placeholder="Buscar por cliente, email, organización, NIT..."
