      ...
      <div className="flex-1 w-full sm:w-auto">
        ...
        <div className="relative">
          ...
          <Input
            ...
            placeholder={t('common.placeholders.searchCategories')}
        ...
        <div className="w-full sm:w-[180px]">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="active">{isMobile ? "Activas" : "Solo activas"}</SelectItem>
              <SelectItem value="inactive">{isMobile ? "Inactivas" : "Solo inactivas"}</SelectItem>
            </SelectContent>
          </Select>
        </div>
