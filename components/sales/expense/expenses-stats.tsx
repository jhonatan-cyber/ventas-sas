  ...
  return (
    <div className="grid gap-3 sm:gap-4 grid-cols-2 lg:grid-cols-4">
      ...
      <Card className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950/20 dark:to-emerald-900/20 border-emerald-200 dark:border-emerald-800">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-xs sm:text-sm font-medium text-emerald-900 dark:text-emerald-100">
            Gastos del Mes
          </CardTitle>
          <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-lg bg-emerald-500 dark:bg-emerald-600 flex items-center justify-center">
        ...
        <CardContent>
          ...
          <p className="text-[10px] sm:text-xs text-emerald-700 dark:text-emerald-300 mt-1 line-clamp-2">
            {isLoading ? "--" : formatCurrencyWithPreferences(monthAmount)} en el mes
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-950/20 dark:to-amber-900/20 border-amber-200 dark:border-amber-800">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-lg bg-amber-500 dark:bg-amber-600 flex items-center justify-center">
            <GaugeCircle className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
          </div>
        </CardHeader>
        <CardContent>
          <div className="text-base sm:text-lg md:text-xl font-bold text-amber-900 dark:text-amber-100 break-words">
            {isLoading
              ? "--"
              : formatCurrencyWithPreferences(averageAmount)}
          </div>
          <p className="text-[10px] sm:text-xs text-amber-700 dark:text-amber-300 mt-1 line-clamp-2">
